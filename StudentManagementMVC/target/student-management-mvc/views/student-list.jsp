...
<body>
    ...
    <!-- Add New + Search Bar -->
    <div class="top-actions" style=" display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; gap: 20px;">

        <!-- Add New Student Button -->
        <a href="student?action=new" class="btn btn-primary" style="white-space: nowrap;">
            ➕ Add New Student
        </a>
        ...
        <!-- Search Message -->
        <c:if test="${not empty keyword}">
            <div class ="message" style ="background:#eef; margin-top:10px; padding:10px; border-radius:5px;">
